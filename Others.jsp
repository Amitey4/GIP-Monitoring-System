...
<html lang="en">
    <head>
        ...
        <title>GIP Monitoring - Others | GIP Portal | DOLE</title>
    ...
    <body>
        <%
            class GipRecord {
                ...
                public GipRecord(String idNo, String lastName, String firstName, String middleName, String extensionName,
                        ...
                        String contactNumber, String sex, String birthDate, String startDate, String endDate, String status,
                    ...
                    this.barangay = barangay != null ? barangay : "";
                ...
                public String getFullAddress() {
                    // Build address safely, handling null values
                    ...
                    if (municipality != null && !municipality.trim().isEmpty()) {
                        if (addressBuilder.length() > 0) addressBuilder.append(", ");
                        addressBuilder.append(municipality);
                    }
                    ...
                    return addressBuilder.length() > 0 ? addressBuilder.toString() : "No address provided";
                }
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    GipRecord record = new GipRecord(
                            ...
                            contactNumber, sex, formattedBirthDate, formattedStartDate, formattedEndDate,
                ...
                <div class="main-content">
                    <div class="dashboard-section">
                        ...
                        <div class="export-buttons">
                            <a href="OexcelGIP.jsp" class="export-btn">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%= record.designation != null ? record.designation : "N/A"%></td>
        ...
        <div id="addModal" class="modal">
            <div class="modal-content">
                ...
                <form action="OaddGIP.jsp" method="post" onsubmit="return validateAddForm()">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="municipality" value="<%= bayanName%>">
                    </div>
        ...
        <div id="editModal" class="modal">
            <div class="modal-content">
                ...
                <form action="OeditGIP.jsp" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="editDesignation" name="editDesignation" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="editStreet">Address</label>
                            <input type="text" id="editAddress" name="editAddress" class="form-control" required>
                        </div>
                        <div class="form-group">
        ...
        <div id="workDetailsModal" class="modal">
            <div class="modal-content">
                ...
                <form action="WorkDetails.jsp" method="post">
        ...
        <script>
            ...
            // Delete confirmation function - FIXED
